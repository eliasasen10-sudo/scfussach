...
function NextMatchBanner() {
  ...
  return (
    <motion.div
      {...fadeUp(0.25)}
      className="w-full max-w-sm mx-auto mb-8 bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl px-4 py-4"
    >
      {/* Label */}
      ...
      <div className="flex items-start justify-center gap-2 mb-3">
        ...
        <div className="flex flex-col items-center gap-1.5 w-24">
          <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
            {opponentLogo ? (
              <Image src={opponentLogo} alt={opponent} width={36} height={36} className="object-contain rounded-full" unoptimized />
            ) : (
