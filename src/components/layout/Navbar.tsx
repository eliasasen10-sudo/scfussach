        ...
        <div className="flex items-center justify-between h-16 md:h-18">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="hidden md:flex w-8 h-8 items-center justify-center rounded-lg text-gray-500 hover:text-primary hover:bg-gray-100 transition-colors duration-200"
            >
